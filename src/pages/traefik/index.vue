...
<script>
import ListBase from "@/pages/traefik/list/index.vue"
import FormBase from "@/pages/traefik/form/base/index.vue"
import EditBase from "@/pages/traefik/edit/base/index.vue"
import DetailBase from "@/pages/traefik/detail/base/index.vue";
