    ...
    >
      <div class="form-basic-container">
        <div class="form-basic-item">
          <div class="form-basic-container-title">镜像基本信息</div>
          <!-- 表单内容 -->
          ...
          <t-row class="row-gap" :gutter="[16, 24]">
            ...
            <t-col :span="6">
              <t-form-item label="镜像平台类型" name="type">
                <t-select
...
<!--            </t-col>-->
            ...
            <t-col :span="6">
              <t-form-item label="镜像tag" name="partyA">
                <t-input></t-input>
              </t-form-item>
            </t-col>
            <t-col :span="6">
            ...
            <t-col :span="6">
              <t-form-item label="构建超时(s)" name="endDate">
                <t-input
